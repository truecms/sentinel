-- Comprehensive sample data for monitoring dashboard
-- This includes data for better compliance rate and critical issues
...
-- Insert sample modules with more variety
...
('media', 'Media', 'core', true, true, NOW(), NOW());
...
FROM (VALUES 
    -- Views module versions (critical security issue)
    ('views', '9.5.0', false, true),
    ('views', '9.5.1', true, true),  -- Security update
    ('views', '9.5.2', false, true),
    ('views', '9.5.3', true, true),  -- Latest with security fix
    
    -- Node module versions  
    ('node', '10.1.0', false, true),
    ('node', '10.1.1', true, true),  -- Security update
    ('node', '10.1.2', false, true), -- Latest
    
    -- User module versions
    ('user', '10.1.0', false, true),
    ('user', '10.1.1', false, true), -- Latest
    ...
    -- Media versions (core)
    ('media', '10.1.0', false, true),
    ('media', '10.1.1', false, true) -- Latest
...
('Development Site', 'https://dev.example.com', 'site-uuid-6', 'token-6', '10.1.0', true, NOW(), NOW(), 1),
('Staging Site', 'https://staging.example.com', 'site-uuid-7', 'token-7', '10.1.0', true, NOW(), NOW(), 1),
('Documentation Site', 'https://docs.example.com', 'site-uuid-8', 'token-8', '10.1.0', true, NOW(), NOW(), 2);
...
FROM (VALUES
    ...
    ('site-uuid-1', 'views', '9.5.0', '9.5.3', true, true, true),           -- Critical security issue
    ('site-uuid-1', 'node', '10.1.0', '10.1.2', true, true, true),          -- Security update available
    ('site-uuid-1', 'user', '10.1.0', '10.1.1', true, true, false),         -- Regular update
    ...
    ('site-uuid-2', 'views', '9.5.2', '9.5.3', true, true, true),           -- Security update available
    ('site-uuid-2', 'node', '10.1.2', '10.1.2', true, false, false),        -- Up to date
    ('site-uuid-2', 'user', '10.1.1', '10.1.1', true, false, false),        -- Up to date
    ...
    ('site-uuid-3', 'views', '9.5.0', '9.5.3', true, true, true),           -- Critical security issue
    ('site-uuid-3', 'user', '10.1.0', '10.1.1', true, true, false),         -- Regular update
    ...
    ('site-uuid-4', 'views', '9.5.3', '9.5.3', true, false, false),         -- Up to date
    ('site-uuid-4', 'node', '10.1.2', '10.1.2', true, false, false),        -- Up to date
    ('site-uuid-4', 'user', '10.1.1', '10.1.1', true, false, false),        -- Up to date
    ...
    ('site-uuid-5', 'views', '9.5.0', '9.5.3', true, true, true),           -- Critical security issue
    ('site-uuid-5', 'node', '10.1.0', '10.1.2', true, true, true),          -- Security update available
    ...
    ('site-uuid-5', 'media', '10.1.0', '10.1.1', true, true, false),        -- Regular update
    
    -- Development Site (MOSTLY UP TO DATE - good compliance)
    ('site-uuid-6', 'views', '9.5.3', '9.5.3', true, false, false),         -- Up to date
    ('site-uuid-6', 'node', '10.1.2', '10.1.2', true, false, false),        -- Up to date
    ('site-uuid-6', 'user', '10.1.1', '10.1.1', true, false, false),        -- Up to date
    ...
    ('site-uuid-7', 'views', '9.5.3', '9.5.3', true, false, false),         -- Up to date
    ('site-uuid-7', 'node', '10.1.2', '10.1.2', true, false, false),        -- Up to date
    ('site-uuid-7', 'user', '10.1.1', '10.1.1', true, false, false),        -- Up to date
    ...
    ('site-uuid-8', 'views', '9.5.3', '9.5.3', true, false, false),         -- Up to date
    ('site-uuid-8', 'node', '10.1.2', '10.1.2', true, false, false),        -- Up to date
    ('site-uuid-8', 'user', '10.1.1', '10.1.1', true, false, false),        -- Up to date
    ('site-uuid-8', 'media', '10.1.1', '10.1.1', true, false, false),       -- Up to date
