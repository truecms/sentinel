...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_modules_machine_name"), "modules", ["machine_name"], unique=True
    )
    ...
    op.create_index(
        "idx_module_version_date",
        "module_versions",
        ["module_id", "release_date"],
        unique=False,
    )
    op.create_index(
        "idx_module_version_security",
        "module_versions",
        ["module_id", "is_security_update"],
        unique=False,
    )
    op.create_index(
        op.f("ix_module_versions_id"), "module_versions", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_module_versions_module_id"),
        "module_versions",
        ["module_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "security_update_available", sa.Boolean(), nullable=False, default=False
        ),
        sa.Column("latest_version_id", sa.Integer(), nullable=True),
        sa.Column("is_active", sa.Boolean(), nullable=True, default=True),
        sa.Column("is_deleted", sa.Boolean(), nullable=True, default=False),
        sa.Column(
            "first_seen", sa.DateTime(), server_default=sa.text("now()"), nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        ...
        "site_modules",
        ["site_id", "update_available", "security_update_available"],
        unique=False,
    )
    op.create_index(op.f("ix_site_modules_id"), "site_modules", ["id"], unique=False)
    op.create_index(
        op.f("ix_site_modules_module_id"), "site_modules", ["module_id"], unique=False
    )
    op.create_index(
        op.f("ix_site_modules_site_id"), "site_modules", ["site_id"], unique=False
    )
    ...
    op.create_foreign_key(
        None, "user_organizations", "organizations", ["organization_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        None, "site_modules", "module_versions", ["current_version_id"], ["id"]
    )
    op.create_foreign_key(
        None, "site_modules", "module_versions", ["latest_version_id"], ["id"]
    )
