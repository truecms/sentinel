...
class SiteModuleCreate(SiteModuleBase):
    ...
    current_version_id: int = Field(..., description="ID of the currently installed version")
...
class SiteModuleUpdate(BaseModel):
    ...
    current_version_id: Optional[int] = Field(None, description="ID of the new current version")
...
class SiteModuleInDB(SiteModuleBase):
    ...
    security_update_available: bool = Field(..., description="Whether a security update is available")
    latest_version_id: Optional[int] = Field(None, description="ID of the latest available version")
    first_seen: datetime = Field(..., description="When this module was first detected on the site")
    last_seen: datetime = Field(..., description="When this module was last seen on the site")
    last_updated: Optional[datetime] = Field(None, description="When the version was last changed")
    is_active: bool
    is_deleted: bool
    created_at: datetime
    updated_at: datetime
...
class SiteModuleResponse(SiteModuleInDB):
    ...
    current_version: ModuleVersionResponse = Field(..., description="Currently installed version")
    latest_version: Optional[ModuleVersionResponse] = Field(None, description="Latest available version")
...
class SiteModuleStatsResponse(BaseModel):
    ...
    modules_with_updates: int = Field(..., description="Number of modules with available updates")
    modules_with_security_updates: int = Field(..., description="Number of modules with security updates")
