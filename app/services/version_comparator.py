...
class VersionComparator:
    ...
    def get_latest_version(self, versions: List[str], stable_only: bool = False) -> Optional[str]:
        """
        ...
        for version in versions:
            try:
                ...
                if stable_only and parsed.release_type not in [ReleaseType.STABLE, ReleaseType.SECURITY]:
                    continue
    ...
    def is_security_update_available(
        ...
        for version in available:
            try:
                ...
                if (parsed.release_type == ReleaseType.SECURITY and 
                    self.compare(current, version) < 0):
    ...
    def calculate_version_distance(self, version1: str, version2: str) -> Dict[str, int]:
        ...
        return {
            ...
            'release_type_diff': parsed2.release_type.precedence - parsed1.release_type.precedence
        }