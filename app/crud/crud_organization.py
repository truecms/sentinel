...
def create_organization(
    db: Session, organization: OrganizationCreate, created_by: int
) -> Organization:
...
def update_organization(
    db: Session, organization_id: int, organization: OrganizationUpdate, updated_by: int
...
def delete_organization(
    db: Session, organization_id: int, updated_by: int
) -> Optional[Organization]:
    db_organization = get_organization(db, organization_id)
    if db_organization:
