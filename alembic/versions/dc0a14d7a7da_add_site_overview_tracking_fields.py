...
def upgrade() -> None:
    ...
    op.add_column('sites', sa.Column('security_score', sa.Integer(), nullable=True, default=0))
    op.add_column('sites', sa.Column('total_modules_count', sa.Integer(), nullable=True, default=0))
    op.add_column('sites', sa.Column('security_updates_count', sa.Integer(), nullable=True, default=0))
    op.add_column('sites', sa.Column('non_security_updates_count', sa.Integer(), nullable=True, default=0))
    op.add_column('sites', sa.Column('last_data_push', sa.DateTime(), nullable=True))
    op.add_column('sites', sa.Column('last_drupal_org_check', sa.DateTime(), nullable=True))
    ...
    op.create_index('ix_sites_last_drupal_org_check', 'sites', ['last_drupal_org_check'])
