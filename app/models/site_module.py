...
from sqlalchemy import Boolean, Column, Integer, DateTime, ForeignKey, UniqueConstraint, Index, text
...
class SiteModule(Base):
    ...
    current_version = relationship("ModuleVersion", foreign_keys=[current_version_id], back_populates="site_modules")
    latest_version = relationship("ModuleVersion", foreign_keys=[latest_version_id], back_populates="site_modules_latest")
