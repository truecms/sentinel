...
class TestVersionComparator:
    ...
    def test_get_latest_version(self, comparator):
        ...
        latest_stable_pre = comparator.get_latest_version(pre_releases, stable_only=True)
    ...
    def test_is_security_update_available(self, comparator):
        ...
        has_security, version = comparator.is_security_update_available("1.0.0", available)
        assert has_security is True
        assert version == "2.0.0-security1"
        
        # No security update
        has_security, version = comparator.is_security_update_available("2.0.0-security1", available)
        ...
        has_security, version = comparator.is_security_update_available("8.x-1.0", drupal_versions)
        assert has_security is True
