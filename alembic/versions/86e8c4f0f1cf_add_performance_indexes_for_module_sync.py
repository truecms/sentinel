...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # Drop indexes
    op.drop_index('ix_site_modules_is_deleted', table_name='site_modules')
    op.drop_index('ix_module_versions_is_deleted', table_name='module_versions')
    op.drop_index('ix_modules_is_deleted', table_name='modules')
    op.drop_index('ix_site_modules_site_id_module_id', table_name='site_modules')
    op.drop_index('ix_module_versions_module_id_version_string', table_name='module_versions')
    op.drop_index('ix_modules_machine_name', table_name='modules')
    # ### end Alembic commands ###
