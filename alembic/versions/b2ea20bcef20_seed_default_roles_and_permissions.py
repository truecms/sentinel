...
def upgrade() -> None:
    ...
    roles_data = [
        ...
        ('org_admin', 'Organization Administrator', 'Full access within organization scope', True),
        ('site_manager', 'Site Manager', 'Manage specific sites and their modules', True),
    ...
    role_permissions_mapping = {
        ...
        'org_admin': [
            ...
            'site:*', 'user:*', 'module:*', 'report:*', 'api_key:*'
        ],
        'site_manager': [
            'site:read', 'site:write', 'site:sync',
            'module:read', 'module:write',
            'report:read', 'api_key:read'
        ],
        'viewer': [
            'organization:read', 'site:read', 'module:read', 'report:read'
        ]
    }
    ...
    permissions_result = conn.execute(sa.select(permissions_table.c.id, permissions_table.c.name))
