...
async def test_sample_data():
    ...
    try:
        ...
        try:
            ...
            site_modules_count = await connection.fetchval("SELECT COUNT(*) FROM site_modules")
            ...
            assert site_modules_count > 40, f"Expected >40 site modules, got {site_modules_count}"
            ...
            compliance_rate = (compliant_sites / total_sites * 100) if total_sites > 0 else 100
            ...
            assert 0 < compliance_rate < 100, f"Expected realistic compliance rate, got {compliance_rate:.1f}%"
            ...
            for site in sites_info:
                ...
                print(f"  {site['name']}: {site['total_modules']} modules, {site['modules_needing_update']} need updates, {site['security_updates']} security updates")
